...
object Calculator {
    ...
    fun durationInDaysAndHours(context: Context, from: LocalDateTime, to: LocalDateTime): String {
        ...
        val daysWithUnit =
            context.resources.getQuantityString(R.plurals.datetimeLib_days, days, days)
        val hoursWithUnit =
            context.resources.getQuantityString(R.plurals.datetimeLib_hours, hours, hours)
        return when {
